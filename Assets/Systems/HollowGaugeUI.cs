...
namespace Assortedarmaments.Assets.Systems
{
    public class HollowGaugeUI : UIState
    {
        ...
        public override void OnInitialize()
        {
            ...
            barFrame = new UIImage(ModContent.Request<Texture2D>("Assortedarmaments/Assets/Systems/HollowGaugeUI")); // Frame of our resource bar
